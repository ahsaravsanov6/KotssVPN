...
# ── Кнопки главного меню во время FSM-диалога ─────────────────────────────────
#
# После перехода на новую структуру навигации (главное меню = 3 reply-кнопки:
# Мой VPN, Подписка, Ещё) только эти кнопки реально приходят как F.text.
# Личный кабинет, рефералка, новости, поддержка и о нас теперь инлайн-кнопки
# внутри раздела "Ещё" и не пересекаются с FSM-диалогами как текст.
...
# ── Неизвестный callback (устаревшие кнопки) ─────────────────────────────────
